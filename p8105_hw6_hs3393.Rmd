...
coef(models, id = 4)
```
Use adjusted R squared as the criteria, we can see that after the variable number greater than 4, the contribution of adding a new variavle will help adjusted R squared increase less than 0.001, which is of trivial effect for the full model, so we use 7 as the cutoff point. 
